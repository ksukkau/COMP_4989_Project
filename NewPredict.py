...
classes = [i.split(os.path.sep)[1] for i in glob.glob('./videos_test/*')]

video_path = './videos_test/test/1.mp4'
...
tf.expand_dims(sample_video, axis=-1)
print(sample_video.shape)

#makes a gif from the sample
def to_gif(images):
